...
//  TrainLoaded
//
//  Created by Brandon Mantzey on 10/16/08.
//
...
static inline void m3dLoadVector2f(M3DVector2f v, float x, float y)
{ v[0] = x; v[1] = y; }
static inline void m3dLoadVector2d(M3DVector2d v, float x, float y)
{ v[0] = x; v[1] = y; }
static inline void m3dLoadVector3f(M3DVector3f v, float x, float y, float z) 
{ v[0] = x; v[1] = y; v[2] = z; }
static inline void m3dLoadVector3d(M3DVector3d v, double x, double y, double z)
{ v[0] = x; v[1] = y; v[2] = z; }
static inline void m3dLoadVector4f(M3DVector4f v, float x, float y, float z, float w) 
{ v[0] = x; v[1] = y; v[2] = z; v[3] = w;}
static inline void m3dLoadVector4d(M3DVector4d v, double x, double y, double z, double w)
{ v[0] = x; v[1] = y; v[2] = z; v[3] = w;}

////////////////////////////////////////////////////////////////////////////////
// Copy vector src into vector dst
static inline void	m3dCopyVector2f(M3DVector2f dst, const M3DVector2f src) 
{ memcpy(dst, src, sizeof(M3DVector2f)); }
static inline void	m3dCopyVector2d(M3DVector2d dst, const M3DVector2d src) 
...
static inline void	m3dCopyVector3d(M3DVector3d dst, const M3DVector3d src)
{ memcpy(dst, src, sizeof(M3DVector3d)); }
static inline void	m3dCopyVector4f(M3DVector4f dst, const M3DVector4f src)
{ memcpy(dst, src, sizeof(M3DVector4f)); }
static inline void	m3dCopyVector4d(M3DVector4d dst, const M3DVector4d src)
{ memcpy(dst, src, sizeof(M3DVector4d)); }

////////////////////////////////////////////////////////////////////////////////
// Add Vectors (r, a, b) r = a + b
static inline void m3dAddVectors2f(M3DVector2f r, const M3DVector2f a, const M3DVector2f b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1];  }
static inline void m3dAddVectors2d(M3DVector2d r, const M3DVector2d a, const M3DVector2d b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1];  }

static inline void m3dAddVectors3f(M3DVector3f r, const M3DVector3f a, const M3DVector3f b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1]; r[2] = a[2] + b[2]; }
static inline void m3dAddVectors3d(M3DVector3d r, const M3DVector3d a, const M3DVector3d b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1]; r[2] = a[2] + b[2]; }

static inline void m3dAddVectors4f(M3DVector4f r, const M3DVector4f a, const M3DVector4f b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1]; r[2] = a[2] + b[2]; r[3] = a[3] + b[3]; }
static inline void m3dAddVectors4d(M3DVector4d r, const M3DVector4d a, const M3DVector4d b)
{ r[0] = a[0] + b[0];	r[1] = a[1] + b[1]; r[2] = a[2] + b[2]; r[3] = a[3] + b[3]; }

////////////////////////////////////////////////////////////////////////////////
// Subtract Vectors (r, a, b) r = a - b
static inline void m3dSubtractVectors2f(M3DVector2f r, const M3DVector2f a, const M3DVector2f b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1];  }
static inline void m3dSubtractVectors2d(M3DVector2d r, const M3DVector2d a, const M3DVector2d b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1]; }

static inline void m3dSubtractVectors3f(M3DVector3f r, const M3DVector3f a, const M3DVector3f b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1]; r[2] = a[2] - b[2]; }
static inline void m3dSubtractVectors3d(M3DVector3d r, const M3DVector3d a, const M3DVector3d b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1]; r[2] = a[2] - b[2]; }

static inline void m3dSubtractVectors4f(M3DVector4f r, const M3DVector4f a, const M3DVector4f b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1]; r[2] = a[2] - b[2]; r[3] = a[3] - b[3]; }
static inline void m3dSubtractVectors4d(M3DVector4d r, const M3DVector4d a, const M3DVector4d b)
{ r[0] = a[0] - b[0]; r[1] = a[1] - b[1]; r[2] = a[2] - b[2]; r[3] = a[3] - b[3]; }


///////////////////////////////////////////////////////////////////////////////////////
// Scale Vectors (in place)
static inline void m3dScaleVector2f(M3DVector2f v, float scale) 
{ v[0] *= scale; v[1] *= scale; }
static inline void m3dScaleVector2d(M3DVector2d v, double scale) 
{ v[0] *= scale; v[1] *= scale; }

static inline void m3dScaleVector3f(M3DVector3f v, float scale) 
{ v[0] *= scale; v[1] *= scale; v[2] *= scale; }
static inline void m3dScaleVector3d(M3DVector3d v, double scale) 
{ v[0] *= scale; v[1] *= scale; v[2] *= scale; }

static inline void m3dScaleVector4f(M3DVector4f v, float scale) 
{ v[0] *= scale; v[1] *= scale; v[2] *= scale; v[3] *= scale; }
static inline void m3dScaleVector4d(M3DVector4d v, double scale) 
{ v[0] *= scale; v[1] *= scale; v[2] *= scale; v[3] *= scale; }
...
static inline void m3dCrossProductf(M3DVector3f result, const M3DVector3f u, const M3DVector3f v)
{
...
static inline void m3dCrossProductd(M3DVector3d result, const M3DVector3d u, const M3DVector3d v)
{
	result[0] = u[1]*v[2] - v[1]*u[2];
	result[1] = -u[0]*v[2] + v[0]*u[2];
	result[2] = u[0]*v[1] - v[0]*u[1];
...
// return u dot v
static inline float m3dDotProductf(const M3DVector3f u, const M3DVector3f v)
{ return u[0]*v[0] + u[1]*v[1] + u[2]*v[2]; }

static inline double m3dDotProductd(const M3DVector3d u, const M3DVector3d v)
{ return u[0]*v[0] + u[1]*v[1] + u[2]*v[2]; }

//////////////////////////////////////////////////////////////////////////////////////
// Angle between vectors, only for three component vectors. Angle is in radians...
inline float m3dGetAngleBetweenVectorsf(const M3DVector3f u, const M3DVector3f v)
{
    float dTemp = m3dDotProductf(u, v);
    return acos(dTemp);
}

inline double m3dGetAngleBetweenVectorsd(const M3DVector3d u, const M3DVector3d v)
{
    return acos(m3dDotProductd(u, v));
}
...
static inline double m3dGetVectorLengthSquaredd(const M3DVector3d u)
{ return (u[0] * u[0]) + (u[1] * u[1]) + (u[2] * u[2]); }
...
{ return sqrt(m3dGetVectorLengthSquaredf(u)); }

static inline double m3dGetVectorLengthd(const M3DVector3d u)
{ return sqrt(m3dGetVectorLengthSquaredd(u)); }
...
static inline void m3dNormalizeVectord(M3DVector3d u)
{ m3dScaleVector3d(u, 1.0 / m3dGetVectorLengthd(u)); }
...
// Located in math.cpp
float m3dGetDistanceSquaredf(const M3DVector3f u, const M3DVector3f v);
double m3dGetDistanceSquaredd(const M3DVector3d u, const M3DVector3d v);

static inline double m3dGetDistanced(const M3DVector3d u, const M3DVector3d v)
{ 
	return sqrt(m3dGetDistanceSquaredd(u, v));
}

static inline float m3dGetDistancef(const M3DVector3f u, const M3DVector3f v)
{
	return sqrt(m3dGetDistanceSquaredf(u, v));
}

static inline float m3dGetMagnitudeSquaredf(const M3DVector3f u) 
{
	return u[0]*u[0] + u[1]*u[1] + u[2]*u[2];
}
static inline double m3dGetMagnitudeSquaredd(const M3DVector3d u) 
{
	return u[0]*u[0] + u[1]*u[1] + u[2]*u[2];
}

static inline float m3dGetMagnitudef(const M3DVector3f u) 
{
	return sqrt(m3dGetMagnitudeSquaredf(u));
}
static inline double m3dGetMagnituded(const M3DVector3d u) 
{
	return sqrt(m3dGetMagnitudeSquaredd(u));
}
...
// Copy Matrix
// Brain-dead memcpy
static inline void m3dCopyMatrix33f(M3DMatrix33f dst, const M3DMatrix33f src)
{ memcpy(dst, src, sizeof(M3DMatrix33f)); }

static inline void m3dCopyMatrix33d(M3DMatrix33d dst, const M3DMatrix33d src)
{ memcpy(dst, src, sizeof(M3DMatrix33d)); }

static inline void m3dCopyMatrix44f(M3DMatrix44f dst, const M3DMatrix44f src)
{ memcpy(dst, src, sizeof(M3DMatrix44f)); }

static inline void m3dCopyMatrix44d(M3DMatrix44d dst, const M3DMatrix44d src)
...
/////////////////////////////////////////////////////////////////////////////
// Get/Set Column.
static inline void m3dGetMatrixColumn33f(M3DVector3f dst, const M3DMatrix33f src, int column)
{ memcpy(dst, src + (3 * column), sizeof(float) * 3); }

static inline void m3dGetMatrixColumn33d(M3DVector3d dst, const M3DMatrix33d src, int column)
{ memcpy(dst, src + (3 * column), sizeof(double) * 3); }

static inline void m3dSetMatrixColumn33f(M3DMatrix33f dst, const M3DVector3f src, int column)
{ memcpy(dst + (3 * column), src, sizeof(float) * 3); }

static inline void m3dSetMatrixColumn33d(M3DMatrix33d dst, const M3DVector3d src, int column)
{ memcpy(dst + (3 * column), src, sizeof(double) * 3); }

static inline void m3dGetMatrixColumn44f(M3DVector4f dst, const M3DMatrix44f src, int column)
{ memcpy(dst, src + (4 * column), sizeof(float) * 4); }

static inline void m3dGetMatrixColumn44d(M3DVector4d dst, const M3DMatrix44d src, int column)
{ memcpy(dst, src + (4 * column), sizeof(double) * 4); }

static inline void m3dSetMatrixColumn44f(M3DMatrix44f dst, const M3DVector4f src, int column)
{ memcpy(dst + (4 * column), src, sizeof(float) * 4); }

static inline void m3dSetMatrixColumn44d(M3DMatrix44d dst, const M3DVector4d src, int column)
...
static inline void m3dSetMatrixRowCol33f(M3DMatrix33f m, int row, int col, float value)
{ m[(col * 3) + row] = value; }

static inline float m3dGetMatrixRowCol33f(const M3DMatrix33f m, int row, int col)
{ return m[(col * 3) + row]; }

static inline void m3dSetMatrixRowCol33d(M3DMatrix33d m, int row, int col, double value)
{ m[(col * 3) + row] = value; }

static inline double m3dGetMatrixRowCol33d(const M3DMatrix33d m, int row, int col)
{ return m[(col * 3) + row]; }

static inline void m3dSetMatrixRowCol44f(M3DMatrix44f m, int row, int col, float value)
{ m[(col * 4) + row] = value; }

static inline float m3dGetMatrixRowCol44f(const M3DMatrix44f m, int row, int col)
{ return m[(col * 4) + row]; }

static inline void m3dSetMatrixRowCol44d(M3DMatrix44d m, int row, int col, double value)
{ m[(col * 4) + row] = value; }

static inline double m3dGetMatrixRowCol44d(const M3DMatrix44d m, int row, int col)
{ return m[(col * 4) + row]; }
...
static inline void m3dExtractRotationf(M3DMatrix33f dst, const M3DMatrix44f src)
{	
...
static inline void m3dExtractRotationd(M3DMatrix33d dst, const M3DMatrix44d src)
{
...
static inline void m3dInjectRotationf(M3DMatrix44f dst, const M3DMatrix33f src)
{
...
static inline void m3dInjectRotationd(M3DMatrix44d dst, const M3DMatrix33d src)
{
...
// with this....
static inline void m3dTransformVector3f(M3DVector3f vOut, const M3DVector3f v, const M3DMatrix44f m)
{
...
// Ditto above, but for doubles
static inline void m3dTransformVector3d(M3DVector3d vOut, const M3DVector3d v, const M3DMatrix44d m)
{
    vOut[0] = m[0] * v[0] + m[4] * v[1] + m[8] *  v[2] + m[12];// * v[3];	 
    vOut[1] = m[1] * v[0] + m[5] * v[1] + m[9] *  v[2] + m[13];// * v[3];	
    vOut[2] = m[2] * v[0] + m[6] * v[1] + m[10] * v[2] + m[14];// * v[3];	
...
static inline void m3dTransformVector4f(M3DVector4f vOut, const M3DVector4f v, const M3DMatrix44f m)
{
    vOut[0] = m[0] * v[0] + m[4] * v[1] + m[8] *  v[2] + m[12] * v[3];	 
    vOut[1] = m[1] * v[0] + m[5] * v[1] + m[9] *  v[2] + m[13] * v[3];	
    vOut[2] = m[2] * v[0] + m[6] * v[1] + m[10] * v[2] + m[14] * v[3];	
...
// Ditto above, but for doubles
static inline void m3dTransformVector4d(M3DVector4d vOut, const M3DVector4d v, const M3DMatrix44d m)
{
    vOut[0] = m[0] * v[0] + m[4] * v[1] + m[8] *  v[2] + m[12] * v[3];	 
    vOut[1] = m[1] * v[0] + m[5] * v[1] + m[9] *  v[2] + m[13] * v[3];	
    vOut[2] = m[2] * v[0] + m[6] * v[1] + m[10] * v[2] + m[14] * v[3];	
...
// Matrix.
static inline void m3dRotateVectorf(M3DVector3f vOut, const M3DVector3f p, const M3DMatrix33f m)
{
...
// Ditto above, but for doubles
static inline void m3dRotateVectord(M3DVector3d vOut, const M3DVector3d p, const M3DMatrix33d m)
{
    vOut[0] = m[0] * p[0] + m[3] * p[1] + m[6] * p[2];	
    vOut[1] = m[1] * p[0] + m[4] * p[1] + m[7] * p[2];	
    vOut[2] = m[2] * p[0] + m[5] * p[1] + m[8] * p[2];	
...
static inline void m3dScaleMatrix33f1(M3DMatrix33f m, float scale)
{ for(int i = 8; i >=0; i--) m[i] *= scale; }

static inline void m3dScaleMatrix33d1(M3DMatrix33d m, double scale)
{ for(int i = 8; i >=0; i--) m[i] *= scale; }

static inline void m3dScaleMatrix44f1(M3DMatrix44f m, float scale)
{ for(int i = 15; i >=0; i--) m[i] *= scale; }

static inline void m3dScaleMatrix44d1(M3DMatrix44d m, double scale)
{ for(int i = 15; i >=0; i--) m[i] *= scale; }
...
static inline void m3dTranslationMatrix44f3(M3DMatrix44f m, float x, float y, float z)
{ m3dLoadIdentity44f(m); m[12] = x; m[13] = y; m[14] = z; }

static inline void m3dTranslationMatrix44d3(M3DMatrix44d m, double x, double y, double z)
{ m3dLoadIdentity44d(m); m[12] = x; m[13] = y; m[14] = z; }


// Translate matrix. Only 4x4 matrices supported
static inline void m3dTranslateMatrix44f3(M3DMatrix44f m, float x, float y, float z)
{ m[12] += x; m[13] += y; m[14] += z; }

static inline void m3dTranslateMatrix44d3(M3DMatrix44d m, double x, double y, double z)
{ m[12] += x; m[13] += y; m[14] += z; }


// Scale matrix. Only 4x4 matrices supported
static inline void m3dScaleMatrix44f3(M3DMatrix44f m, float x, float y, float z)
{ m[0] *= x; m[5] *= y; m[10] *= z; }

static inline void m3dScaleMatrix44d3(M3DMatrix44d m, double x, double y, double z)
{ m[0] *= x; m[5] *= y; m[10] *= z; }
...
{ TRANSPOSE44(dst, src); }
static inline void m3dTransposeMatrix44d(M3DMatrix44d dst, const M3DMatrix44d src)
{ TRANSPOSE44(dst, src); }
...
static inline float m3dGetDistanceToPlanef(const M3DVector3f point, const M3DVector4f plane)
{ return point[0]*plane[0] + point[1]*plane[1] + point[2]*plane[2] + plane[3]; }

inline double m3dGetDistanceToPlaned(const M3DVector3d point, const M3DVector4d plane)
{ return point[0]*plane[0] + point[1]*plane[1] + point[2]*plane[2] + plane[3]; }
...
void m3dProjectXYf( M3DVector2f vPointOut, const M3DMatrix44f mModelView, const M3DMatrix44f mProjection,
				   const int iViewPort[4], const M3DVector3f vPointIn);    
//void m3dProjectXYZf(const M3DVector3f vPointOut, const M3DMatrix44f mModelView, const M3DMatrix44f mProjection, 
//					const int iViewPort[4], const M3DVector3f vPointIn);
void m3dProjectXYZf(const M3DMatrix44f mModelView, const M3DMatrix44f mProjection, 
					const int iViewPort[4], const M3DVector3f vPointIn, M3DVector3f vPointOut);
...
static inline bool m3dCloseEnoughf(float fCandidate, float fCompare, float fEpsilon)
{
    return (fabs(fCandidate - fCompare) < fEpsilon);
}

static inline bool m3dCloseEnoughd(double dCandidate, double dCompare, double dEpsilon)
{
...
void m3dCalculateTangentBasisf(const M3DVector3f pvTriangle[3], const M3DVector2f pvTexCoords[3], const M3DVector3f N, M3DVector3f vTangent);
